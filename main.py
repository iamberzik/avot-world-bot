...
load_dotenv()
from core.utils import get_generate_buttons
...
from menu.buttons import MENU_BUTTON_TEXT, PROFILE_BUTTON_TEXT, EDIT_PROFILE_BUTTON_TEXT
...
def register_handlers():
    ...
    bot.register_message_handler(generator_handler, regexp=f'^({get_generate_buttons()})$')
